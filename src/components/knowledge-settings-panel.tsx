...
const KNOWLEDGE_COPY: Record<DisplayLanguage, Partial<KnowledgeCopy>> = {
  en: {
    ...
    retrievalTitle: "Search & Indexing",
    ...
    rerankingTitle: "Advanced ranking is planned but not active",
    rerankingDescription: "This screen keeps future search tuning visible, but ranking and rebuild controls are not yet wired to production behavior.",
    rebuildButton: "Rebuild search index (coming soon)",
  ...
  zh: {
    ...
    chunkSizeLabel: "分块大小",
    overlapLabel: "重叠长度",
    rerankingTitle: "高级排序已规划但尚未启用",
    rerankingDescription: "此页面保留未来搜索调优入口，但排序与重建控件尚未接入正式功能。",
    rebuildButton: "重建搜索索引（即将支持）",
